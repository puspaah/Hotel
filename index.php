...
<head>
    ...
    <title>Hotel Puspa</title>

    <!-- CSS FILES -->
    <title>Puspa Hotel</title>
        <!-- Favicon-->
        <!-- CSS FILES -->        
                ...
                <div class="row">
                    <div class="col-lg-12 col-12">
                        <div class="text-center mb-5 pb-2">
                            <h1 class="text-white">Welcome to Our Hotels</h1>
                            <p class="text-white">Find your perfect stay. Explore our hotels.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="section-title-wrap mb-5">
                            <h4 class="section-title">Available Hotels</h4>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-12 mb-4 mb-lg-0">
                        <div class="custom-block d-flex">
                            <div class="">
                                <div class="custom-block-icon-wrap">
                                    ...
                                    <a href="listing-page.php" class="custom-block-image-wrap">
                                        <img src="images/hotel1.jpeg" class="custom-block-image img-fluid" alt="">
                                    </a>
                                </div>
                                <div class="mt-2">
                                    <a href="listing-page.php" class="btn custom-btn">
                                        Book Now
                                    </a>
                                </div>
                            </div>
                            <div class="custom-block-info">
                                <h5 class="mb-2">
                                    <a href="listing-page.php">Standrad Hotel</a>
                                </h5>
                        ...
                        <div class="custom-block d-flex">
                            <div class="">
                                <div class="custom-block-icon-wrap">
                                    <div class="section-overlay"></div>
                                    <a href="listing-page.php" class="custom-block-image-wrap">
                                        <img src="images/hotel2.jpeg" class="custom-block-image img-fluid" alt="">
                                    </a>
                                </div>
                                <div class="mt-2">
                                    <a href="listing-page.php" class="btn custom-btn">
                            ...
                            <div class="custom-block-info">
                                <h5 class="mb-2">
                                    <a href="listing-page.php">Deluxe</a>
                                </h5>
                        ...
                        <div class="custom-block d-flex">
                            <div class="">
                                <div class="custom-block-icon-wrap">
                                    <div class="section-overlay"></div>
                                    <a href="listing-page.php" class="custom-block-image-wrap">
                                        <img src="images/hotel3.jpeg" class="custom-block-image img-fluid" alt="">
                                    </a>
                                </div>
                                <div class="mt-2">
                                    <a href="listing-page.php" class="btn custom-btn">
                            ...
                            <div class="custom-block-info">
                                <h5 class="mb-2">
                                    <a href="listing-page.php">Family</a>
                                </h5>
                                <p class="mb-0">Rp.1000.000</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <ul class="social-icon">
                        <li class="social-icon-item">
                            <a href="#linkiglupus" class="social-icon-link bi-instagram"></a>
                        </li>
                        <li class="social-icon-item">
                            <a href="#linktwtlupus" class="social-icon-link bi-twitter"></a>
                        </li>
                        <li class="social-icon-item">
                            <a href="#linkwalupus" class="social-icon-link bi-whatsapp"></a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container pt-5">
            <div class="row align-items-center">
                <div class="col-lg-3 col-12">
                    ...
                    <br><br>
                    Design: <a rel="nofollow" href="#about" target="_parent">Puspaayu</a></p>
                </div>
            </div>
        </div>
    </footer>
